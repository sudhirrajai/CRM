...
function submit() {
    form.put(route('marketing.lists.update', props.list.id));
}
</script>
            ...
            <div class="col-12">
                <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column mb-4 mt-2">
                    <div class="flex-grow-1">
                        ...
                        <h4 class="fs-18 text-uppercase fw-bold m-0">Edit Mailing List</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                         <form @submit.prevent="submit">
                            ...
                            <div class="mt-4 pt-3 border-top border-dashed d-flex gap-2">
                                <button type="submit" class="btn btn-primary px-4 fw-bold shadow-sm" :disabled="form.processing">Update List</button>
